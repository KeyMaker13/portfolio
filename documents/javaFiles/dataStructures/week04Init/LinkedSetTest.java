...
public class LinkedSetTest {
  ...
  public static void main(String[] args) {
    ...
    // to try a different implementation change the instantiations below to fit the
    // other classes.

    LinkedSet.setDebug(true);
    System.out.println("Create mySet1: ");
    SetADT<Integer> mySet1 = new LinkedSet<Integer> ();
 ...
 /*   
    ...
    SetADT<Integer> mySet2 = new LinkedSet<Integer>();
    ...
    SetADT<Integer> mySet3 = new LinkedSet<Integer> ();
    ...
    LinkedSet<Integer>  mySetTotal = (LinkedSet<Integer>)mySet1.union(mySet3);
