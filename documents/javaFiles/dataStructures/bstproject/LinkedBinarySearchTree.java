...
public class LinkedBinarySearchTree<T extends Comparable> extends
	...
	private void addElementRecursive(T element, BinaryTreeNode node){
	...
	private T findRecursive(T targetElement, BinaryTreeNode<T> node){
	...
	protected void preorderLevels(BinaryTreeNode<T> node, ArrayList<LevelElement <T>> list, int level){
		if(node!=null){
