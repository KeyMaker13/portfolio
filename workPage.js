...
│   │   │   │   ├── computer.gif
│   │   │   │   ├── hw03.c
│   │   │   │   ├── hw-03-ch2-sp-wordsearch-string-pointer.pdf
│   │   │   │   └── output.txt
│   │   │   ├── hw04
│   │   │   │   ├── hw04.c
│   │   │   │   ├── hw-04-ch2-sp-payroll.pdf
│   │   │   │   ├── output.txt
│   │   │   │   └── valgrindOutput.txt
│   │   │   ├── hw04F
│   │   │   │   ├── hw-04-ch2-sp-payroll.pdf
...
│   │   └── Recitations
│   │       ├── Recitation01
│   │       │   ├── ch01-ex01-arithmetic-exp.pdf
│   │       │   ├── Recitation01.c
│   │       │   └── Recitation01Output
│   │       ├── Recitation02
│   │       │   ├── ch01-ex02-English-text.pdf
│   │       │   ├── Output.txt
│   │       │   ├── Output.txt~
│   │       │   ├── Recitation02.c
│   │       │   └── Recitation02.c~
│   │       ├── Recitation03
│   │       │   ├── ch02-ex02-call-by-ref-line-intersection.pdf
│   │       │   ├── output.txt
│   │       │   └── Recitation03.c
│   │       ├── Recitation04
│   │       │   ├── ch02-ex03-1D-arrays-functions.pdf
│   │       │   ├── output.txt
│   │       │   └── Recitation04.c
│   │       ├── Recitation05
│   │       │   ├── ch02-ex04-string-pointer-arithmetic.pdf
│   │       │   ├── output.txt
│   │       │   └── Recitation05.c
│   │       ├── Recitation06
│   │       │   ├── ch02-ex06-struct-dynamic-memory.pdf
│   │       │   └── Recitation06.c
│   │       ├── Recitation07
│   │       │   ├── ch03-ex02-files.pdf
│   │       │   ├── critical1.txt
...
│   │       │   ├── ch08-ex01-stack.pdf
│   │       │   ├── RPNCalc.c
│   │       │   ├── RPNCalcMineWithMemoryErrors.txt
│   │       │   ├── RPNCalcOutput.txt
│   │       │   ├── stack.c
│   │       │   ├── stack.h
│   │       │   └── valgrindRPNCalc.txt
...
│   │       │   ├── scanadt.c
│   │       │   ├── scanadt.h
│   │       │   ├── valgrindOutputArray.txt
│   │       │   └── valgrindOutputLinkedList.txt
│   │       └── Recitation11
│   │           ├── ch16-ex01-graphs-copy.pdf
│   │           ├── graph.c
│   │           ├── graphTest.txt
│   │           ├── output.txt
...
│   │   │   │   ├── nqueens_library.c
│   │   │   │   ├── nqueens_library.c~
│   │   │   │   ├── nqueens_library.c.save
│   │   │   │   ├── nqueens_library.c.save.1
│   │   │   │   ├── nqueens_library.c.save.2
│   │   │   │   ├── nqueens_library.c.save.3
│   │   │   │   ├── nqueens_library.h
│   │   │   │   └── nqueens_library.h~
│   │   │   ├── assign5
│   │   │   │   ├── client2.c
...
└── javaFiles
    ...
    │   │   ├── StackSymbol.java
    │   │   └── SymbolCheck.java
    │   ├── banksimulationproject
    │   │   ├── BufferedSimulationFirstTest.jpg
    │   │   ├── BufferedSimulation.java
    │   │   ├── BufferedSimulationTester.java
    │   │   ├── BufferedSimulationThirdTest.jpg
    │   │   ├── Clerk.java
    │   │   ├── CustomerGenerator.java
    │   │   ├── Customer.java
    │   │   ├── Event.java
    │   │   ├── Lab07.docx
    │   │   ├── Laboratory7Diagrams.doc
    │   │   ├── LinearNode.java
    │   │   ├── LinkedPriorityQueue.java
    │   │   ├── LinkedQueue.java
    │   │   ├── PriorityQueueADT.java
    │   │   ├── QueueADT.java
    │   │   ├── RandomCustomerGenerator.java
    │   │   ├── RandomCustomerGeneratorTester.java
    │   │   ├── Results.docx
    │   │   ├── StandardCustomerGenerator.java
    │   │   ├── UnbufferedSimulationFirstTest.jpg
    │   │   ├── UnbufferedSimulation.java
    │   │   ├── UnbufferedSimulationSecondTest.jpg
    │   │   ├── UnbufferedSimulationTester.java
    │   │   └── UnbufferedSimulationThirdTest.jpg
    │   ├── bstproject
    ...
    │   │   ├── LinkedBinarySearchTreeTester.java
    │   │   ├── LinkedBinaryTree.java
    │   │   └── LinkedBinaryTreeTester.java
    │   ├── currencyproject
    │   │   ├── Currency.java
    │   │   ├── CurrencyTester.java
    │   │   ├── Dime.java
    ...
    │   ├── dAryheapproject
    │   │   ├── ArrayListHeap.java
    │   │   ├── ArrayListHeapTester.java
    │   │   ├── DAryArrayListHeap.java
    │   │   ├── DAryArrayListHeapTester.java
    │   │   └── HeapADT.java
    │   ├── directoriesproject
    │   │   ├── DirectoryList.java
    │   │   ├── DirectoryListTester.java
    │   │   ├── FileTester.java
    │   │   ├── Results.txt
    │   │   └── test.txt
    │   ├── doublelinksproject
    │   │   ├── ArrayIterator.java
    │   │   ├── ArraySet.java
    │   │   ├── DoubleLinkedIterator.java
    │   │   ├── DoubleLinkedSet.java
    │   │   ├── DoubleLinkedSetTester.java
    │   │   ├── DoubleLinkTester.java
    │   │   ├── DoubleNode.java
    │   │   ├── ElementNotFoundException.java
    ...
    │   │   ├── SetADT.java
    │   │   └── SingleLinkTester.java
    │   ├── huffmanCoding
    │   │   ├── BitInputStream.java
    │   │   ├── BitOutputStream.java
    │   │   ├── HuffmanCodingEntry.java
    │   │   ├── HuffmanDecoder.java
    │   │   ├── HuffmanDecoderTester.java
    │   │   ├── HuffmanEncoder.java
    │   │   ├── HuffmanEncoderTester.java
    │   │   ├── LinearNode.java
    │   │   ├── LinkedPriorityQueue.java
    │   │   ├── LinkedPriorityQueueTester.java
    │   │   ├── LinkedQueue.java
    ...
    │   │   ├── ListADT.java
    │   │   ├── PublicLinkedList.java
    │   │   ├── PublicNode.java
    │   │   ├── ReversibleIterator.java
    │   │   ├── RIForLinkedList.java
    │   │   ├── Tester.java
    │   │   ├── UML.jpg
    │   │   ├── UML.pdf
    │   │   └── UML.ucls
    ...
    │   │   ├── RIForLinkedList.java
    │   │   ├── RIUsingArray.java
    │   │   ├── RIUsingArrayList.java
    │   │   ├── RIUsingLinkedList.java
    │   │   ├── Tester.java
    │   │   ├── UML_Project1.pdf
    │   │   ├── UML_ProjectOne2.jpg
    │   │   └── UML_ProjectOne.jpg
    ...
    │   │   ├── CompareSorts.java
    │   │   ├── FastSort3Way.java
    │   │   ├── FastSort3WayTester.java
    │   │   ├── FastSort.java
    │   │   ├── FastSortTester.java
    │   │   ├── output.txt.txt
    │   │   ├── QuadraticSort.java
    │   │   ├── QuadraticSortTester.java
    │   │   └── Search.java
    │   ├── trysets
    │   │   ├── ArrayIterator.java
    │   │   ├── ArraySet.java
    │   │   ├── ElementNotFoundException.java
    │   │   ├── EmptySetException.java
    │   │   ├── IntegerSetTester.java
    │   │   ├── poe.txt
    │   │   ├── SetADT.java
    │   │   ├── short.txt
    │   │   ├── WordReader.java
    │   │   └── WordReaderTester.java
    │   ├── week01
    │   │   ├── Currency.java
    │   │   └── CurrencyTest.java
    │   ├── week02
    ...
    │   │   ├── LinkedSet.java
    │   │   ├── LinkedStack.java
    │   │   ├── LinkedStackTester.java
    │   │   ├── ListADT.java
    │   │   ├── ModulusOperator.java
    │   │   ├── MultiplicationOperator.java
    │   │   ├── Operand.java
    │   │   ├── PostfixEvaluator2.java
    │   │   ├── PostfixEvaluator.java
    │   │   ├── PostfixEvaluatorTester2.java
    │   │   ├── PostfixEvaluatorTester.java
    │   │   ├── ReverseLinesTest.java
    │   │   ├── SetADT.java
    │   │   ├── SimpleLinkedList.java
    │   │   ├── SimpleNode.java
    │   │   ├── StackADT.java
    ...
    │   │   ├── ArraySetTest.java
    │   │   ├── ArrayStack.java
    │   │   ├── BufferedNodeModel.java
    │   │   ├── BufferedNodeModelTester.java
    │   │   ├── BufferedRouter.java
    │   │   ├── Clerk.java
    │   │   ├── CustomerGenerator.java
    │   │   ├── Customer.java
    ...
    │   │   ├── EventTester.java
    │   │   ├── IncomingLine.java
    │   │   ├── IncomingLineTester.java
    │   │   ├── IncomingOnlyModel.java
    │   │   ├── IncomingOnlyModelTester.java
    │   │   ├── LinearNode.java
    │   │   ├── LinkedIterator.java
    │   │   ├── LinkedListIterator.java
    │   │   ├── LinkedListSet.java
    ...
    │   │   ├── UnbufferedNodeModelTester.java
    │   │   ├── UnbufferedRouter.java
    │   │   ├── UnbufferedSimulation.java
    │   │   └── UnbufferedSimulationTester.java
    │   ├── week06Init
    │   │   ├── ArrayIterator.java
    ...
    │   │   ├── PriorityQueueADT.java
    │   │   ├── Queens.java
    │   │   ├── QueensSimplified.java
    │   │   ├── QueensSimplifiedTester.java
    │   │   ├── QueensTester.java
    │   │   ├── QueueADT.java
    │   │   ├── SetADT.java
    │   │   ├── SimpleLinkedList.java
    ...
    │   │   ├── HuffmanEncoder.java
    │   │   ├── HuffmanEncoderTester.java
    │   │   ├── IndexedLinkedList.class
    │   │   ├── IndexedLinkedList.java
    │   │   ├── IndexedListADT.class
    │   │   ├── IndexedListADT.java
    │   │   ├── LinearNode.class
    │   │   ├── LinearNode.java
    │   │   ├── LinkedBinaryTree.class
    │   │   ├── LinkedBinaryTree.java
    │   │   ├── LinkedBinaryTreeTester.class
    │   │   ├── LinkedBinaryTreeTester.java
    │   │   ├── LinkedInorderTraversalIterator.class
    │   │   ├── LinkedIterator.class
    │   │   ├── LinkedIterator.java
    │   │   ├── LinkedListIterator.java
    │   │   ├── LinkedListSet.java
    │   │   ├── LinkedListTester.java
    │   │   ├── LinkedOrderedSet.class
    │   │   ├── LinkedOrderedSet.java
    │   │   ├── LinkedPriorityQueue.class
    │   │   ├── LinkedPriorityQueue.java
    │   │   ├── LinkedPriorityQueueTester.class
    │   │   ├── LinkedPriorityQueueTester.java
    │   │   ├── LinkedQueue.class
    │   │   ├── LinkedQueue.java
    │   │   ├── LinkedQueueTester.class
    │   │   ├── LinkedQueueTester.java
    │   │   ├── LinkedSet.class
    │   │   ├── LinkedSet.java
    │   │   ├── LinkedSetTest.class
    ...
    │   │   ├── LinkedStack.java
    │   │   ├── ListADT.java
    │   │   ├── NonComparableElementException.class
    │   │   ├── NonComparableElementException.java
    │   │   ├── OrderedLinkedList.class
    │   │   ├── OrderedLinkedList.java
    │   │   ├── OrderedListADT.class
    │   │   ├── OrderedListADT.java
    │   │   ├── PriorityQueueADT.class
    │   │   ├── PriorityQueueADT.java
    │   │   ├── QuadraticSort.java
    │   │   ├── QueueADT.class
    │   │   ├── QueueADT.java
    ...
    │   │   ├── BasicLinkedList.java
    │   │   ├── BinarySearchTreeADT.java
    │   │   ├── BinarySearchTreeOrderedList.java
    │   │   ├── BinarySearchTreeOrderedListTester.java
    │   │   ├── BinaryTreeADT.java
    │   │   ├── BinaryTreeNode.java
    │   │   ├── docit.bat
    │   │   ├── DoubleIterator.java
    ...
    │   │   ├── LinkedBinaryTree.java
    │   │   ├── LinkedBinaryTreeTester.java
    │   │   ├── LinkedInorderTraversalIterator.java
    │   │   ├── LinkedIterator.java
    │   │   ├── LinkedListIterator.java
    │   │   ├── LinkedListSet.java
    │   │   ├── LinkedListTester.java
    ...
    │   │   ├── problemTwo.java
    │   │   ├── problemTwo.java~
    │   │   ├── stringAgainFour.java
    │   │   ├── stringAgainFour.java~
    │   │   ├── stringAgain.java
    │   │   ├── stringAgain.java~
    │   │   ├── stringAgainThree.java
    │   │   ├── stringAgainThree.java~
    │   │   └── stringAgainTwo.java
    │   ├── graphics
    │   │   ├── DrawingPanel.java
    │   │   ├── Hyperbola.java
    │   │   ├── Hyperbola.java~
    │   │   ├── OutlineExample2.java
    │   │   └── OutlineExample2.java~
    │   ├── lab3
    │   │   ├── FutureValues.java
    │   │   ├── FutureValues.java~
    │   │   └── FutureValuesOutput.txt.txt
    │   ├── lab4
    │   │   └── lab4
    │   │       ├── DrawingPanel.java
    │   │       ├── Hyperbola.java
    ...
    │   │   └── Temperatures.java~
    │   ├── Week16
    │   │   ├── 11-spring-final-answers.pdf
    │   │   ├── array2DDoubles.java
    │   │   ├── ArrayString.java
    │   │   └── reviewActivities.java
    │   ├── week6and7
    │   │   ├── StringTest.java
    │   │   └── StringTest.java~
    │   └── Week9
    │       ├── CharacterInterger.java
    │       ├── CharacterInterger.java~
    │       ├── CharacterMethodsTest.java
    │       ├── CharacterMethodsTest.java~
    │       ├── codePaths.java
    │       ├── codePaths.java~
    │       ├── CountAChar.java
    │       ├── CountAChar.java~
    │       ├── CountUpperLower.java
    │       ├── CountUpperLower.java~
    │       ├── DrawingPanel.java
    │       ├── percentCorrect.java
    │       ├── percentCorrect.java~
    │       ├── precondition.java
    │       ├── precondition.java~
    │       ├── ShiftedMovingCircles.java
    │       ├── ShiftedMovingCircles.java~
    │       ├── ShiftedStraightLineMove.java
    │       ├── SwitchCase.java
    │       └── SwitchCase.java~
    └── programmingTwo
        ├── Bonus
        ...
        ├── exam3Practice
        │   └── test.java
        ├── GameLayoutPanel.java
        ├── icapistran3
        │   ├── daily_predictions.txt
        │   ├── daily_results.txt
        │   ├── daily_temperature.txt
        │   ├── pr3
        ...
        │   │   ├── departmentstorepkg
        │   │   │   ├── class-use
        │   │   │   │   ├── DepartmentStore.html
        │   │   │   │   ├── DepartmentStoreTest.html
        │   │   │   │   ├── Employee.html
        │   │   │   │   ├── EmployeeIO.html
        │   │   │   │   ├── EmployeeIOTest.html
        │   │   │   │   ├── Executive.html
        ...
        ├── lab11
        │   └── craps
        │       ├── CrapsApplication.java
        │       ├── CrapsPanel.java
        │       ├── DiceApplet.java
        │       ├── DiceDrawer.java
        │       ├── DicePanel.java
        │       ├── GameLayoutApplication.java
        │       ├── GameLayoutPanel.java
        │       └── SimpleDiceApplication.java
        ├── Labs
        │   └── lab01
        │       ├── error.txt
        │       └── simpleproject
